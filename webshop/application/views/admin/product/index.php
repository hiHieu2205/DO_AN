...
<div class="row">
	...
	<form action="" method="post" >
		<div class="panel panel-info">
			...
			<div class="col-md-8">Quản lý đầu sách</div>
			<div class="col-md-4 text-right"><a href="<?php echo admin_url('product/add'); ?>" class='btn btn-info'><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Thêm đầu sách</a></div>
			</div>
