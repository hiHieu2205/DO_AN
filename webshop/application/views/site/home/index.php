<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/new.gif" alt=""><a href="<?php echo base_url('product/news'); ?>" class='product_title'>Sách mới </a><img src="<?php echo base_url(); ?>upload/icon/new.gif" alt=""></h3>
	  </div>
...
<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""><a href="<?php echo base_url('ban-chay'); ?>" class='product_title'>Sách bán chạy</a><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""></h3>
	  </div>
	  <div class="panel-body">
	  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
...
<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""><a href="<?php echo base_url('product/views'); ?>" class='product_title'>Sách xem nhiều</a><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""></h3>
	  </div>
	  <div class="panel-body">
	  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
