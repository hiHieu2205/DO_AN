			  ...
			  <div class="container-fluid re-container-fluid">
			    ...
			    <div class="collapse navbar-collapse re-navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			        ...
			        <li class="dropdown">
			          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Danh mục sách<span class="caret"></span></a>
					...
					<li><a href="http://localhost/webshop/admin/login">Admin</a></li>
			       </ul>
